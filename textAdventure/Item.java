...
class Item{
	...
	static void makeItem(ArrayList<Item> items) {
		...
		//use?items.add(new Item("screwdriver", "A regular flathead screwdriver, it looks pretty worn", "Maintenance Area", false, false,0,false));
		...
		items.add(new Item("note","There seems to be some writing on it","Dig Site",false,false,0,false));
