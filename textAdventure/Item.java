...
class Item{
	...
	static void makeItem(ArrayList<Item> items) {
		items.add(new Item("torch","A flickering torch","Lab 1" , false, false, 0, false));
		...
		items.add(new Item("artifact","An mysterious looking artifact. While it is in your possession, you feel yourself getting weaker", "Secret Room", false,false, 0, true));
		...
		items.add(new Item("jacket","An old wethered jacket that seems a little worse for ware but keeps you warm when you wear it","Living Quarters", false, false,0, false));
		items.add(new Item("note","There seems to be some writing on it","Dig Site",false,false,0,true));
